...
class GetEquippingLevelRequest extends AAutoStatRequest
{
    ...
    {
        $this->addPayloadValue('paramHierarchy.name', 'Уровень оснащения')
            ->addPayloadValue('paramHierarchy.type', 'folder')
            ->addPayloadValue('paramHierarchy.inner.name', 'Имя уровня')
